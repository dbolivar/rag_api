...
- `EMBEDDINGS_PROVIDER`: (Optional) either "openai", "bedrock", "azure", "huggingface", "huggingfacetei", "vertexai", "ollama" or "voyageai", where "huggingface" uses sentence_transformers; defaults to "openai"
